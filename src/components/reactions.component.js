...
function savereaction(e, status, user, publication, selection) {
    let data = {
      id: 0,
      status: status
    };
    ...
    KafkaService.reaction(user, publication, selection);
    ...
    render(){
        return(
            ...
            onClick={(e) => {
                        ...
                        savereaction(e, 1, this.state.user, this.state.id_publication, this.state.value)
